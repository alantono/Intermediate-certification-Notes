...
def mistake_entry_data(): # ошибочный ввод даты
        ...
        label = Label(mistake_entry, text="На данную дату Заметок нет или Введена некорректная дата.\nВведите дату в формате 2023.03.15", font=("Arial", 11))
        label.pack()
        clear_entry()
        mistake_entry.mainloop()
...
def enter3(event): # Удаление заметки
        ...
        del_note.geometry("200x200+1200+400")
...
note_text = Text(root, width=26, height=10, 
        font=font.Font(family="Arial", size=10)) # поле для ввода текста заметки
